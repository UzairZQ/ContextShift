...
- Bundle E2B in APK vs download on first launch?
...
- [ ] **E2B bundling** — decide: bundle E2B in APK (~2.4GB increase) or download on first launch (bad UX, but smaller install). Research Android App Bundle + Play Feature Delivery for on-demand model delivery.
